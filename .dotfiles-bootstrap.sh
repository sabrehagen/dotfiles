...
# Clone vcsh config first to prevent file conflicts during subsequent dotfiles clones
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-vcsh.git

# Clone ssh dotfiles to enable ssh multiplexing
...
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-discord.git &
...
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-kde.git &
...
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-speedtest.git &
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-tmux.git &
vcsh clone https://sabrehagen@github.com/sabrehagen/dotfiles-vimium.git &
